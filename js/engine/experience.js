...
window.MakmalExperience = (() => {
 ...
 function hint(s,def){
  ...
  if(def.year===1){const h=window.MakmalYear1Lab.hint(s,def);selector=h.selector;clue=h.clue;}else if(def.year===6){const h=window.MakmalYear6Lab.hint(s,def);selector=h.selector;clue=h.clue;}else if(def.year===5){const h=window.MakmalYear5Lab.hint(s,def);selector=h.selector;clue=h.clue;}else if(def.year===4){const h=window.MakmalYear4Lab.hint(s,def);selector=h.selector;clue=h.clue;}else if(def.year===3){const h=window.MakmalYear3Lab.hint(s,def);selector=h.selector;clue=h.clue;}else if(window.MakmalNewContent?.missions[def.id]){const h=window.MakmalDiscovery.hint(s,def);selector=h.selector;clue=h.clue;}else if(def.terminals){
...
function completion(def,unit,celebrateUnit=false){
  if(def.year===1)return window.MakmalYear1Screens.completion(def,celebrateUnit);
  if(def.year===6)return window.MakmalYear6Screens.completion(def,celebrateUnit);
